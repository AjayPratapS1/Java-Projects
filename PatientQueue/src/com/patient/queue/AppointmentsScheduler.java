...
//		appointments.add(new PatientApp("P001", "2025-08-01 10:30", "Dental Checkup", "Ajay"));
//		appointments.add(new PatientApp("P002", "2025-08-01 09:00", "Eye Test", "Ravi"));
//		appointments.add(new PatientApp("P003", "2025-08-01 11:00", "General", "Ravi"));
//		appointments.add(new PatientApp("P001", "2025-08-01 10:30", "Dental Checkup", "Ajay")); // duplicate
//
